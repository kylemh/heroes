...
A fun little project with all of your favorites duking it out.


## Steps Taken (ignoring git)
1. `npx create-react-app heroes`
2. `yarn eject`

3. "Are you sure?!?!?!?!?!?!?!" <br>`y` (yes, I did mean to eject)

4. `yarn add -D node-sass sass-loader`
